...
int prnt_handle(const char *fmt, int *i,
...
int print_hex_lu(va_list types, char map_to[],
...
int print_str(char c, char buffer[],
	int flags, int width, int precision, int size);
int print_str1(int is_positive, int ind, char buffer[],
	int flags, int width, int precision, int size);
...
long int con_size_unsign(unsigned long int num, int size);
